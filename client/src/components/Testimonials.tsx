...
export default function Testimonials() {
  ...
  return (
    <section className="md:py-16 px-10 bg-[#FAFBFF] mobile-p-reduced" id="reviews">
      <div className="container-custom pb-20 mobile-p-reduced">
        {/* Header Content */}
        <div className="mb-20 md:w-1/2 px-2 mb-[5pt]">
          ...
          <div className="overflow-hidden">
            ...
            >
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="bg-white p-4 md:p-5 relative  hover:border border-blue-200 transition-all duration-300 h-full">
                    <div className="flex items-center gap-3 mb-3">
                      {/* Avatar circle */}
                      <div className="w-8 md:w-10 h-8 md:h-10 rounded-full bg-[#7c3aed] border-2 border-white flex items-center justify-center flex-shrink-0">
